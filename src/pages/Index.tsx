        ...
        <div className="px-6">
          <Tabs defaultValue="dashboard" className="w-full">
            <TabsList className="grid w-full grid-cols-5 bg-transparent h-12 border-b-0">
              <TabsTrigger 
                value="dashboard" 
                className="data-[state=active]:bg-yellow-50 data-[state=active]:text-yellow-800 data-[state=active]:border-b-2 data-[state=active]:border-yellow-500 data-[state=active]:shadow-none rounded-none text-gray-500"
              >
                Dashboard
              </TabsTrigger>
              <TabsTrigger 
            ...
            <TabsContent value="dashboard" className="mt-0">
              <div className="py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-8">
                  <Card className="lg:col-span-1 border-l-4 border-l-yellow-500 shadow-sm">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="flex items-center space-x-2">
                        <input type="checkbox" id="showActioned" className="rounded border-gray-300 text-yellow-600 focus:ring-yellow-500" />
                        ...
                        <TableBody>
                          {workQueueData.map((item, index) => (
                            <TableRow key={index} className="hover:bg-gray-50 transition-colors">
                              <TableCell className="font-medium text-yellow-700">{item.id}</TableCell>
                    ...
                    <div className="bg-gray-50 p-6 rounded-lg border">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div className="space-y-2">
                          ...
                          <Input id="accountRef1" placeholder="Enter account reference" className="border-gray-300 focus:border-yellow-500 focus:ring-yellow-500" />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="accountRef2" className="text-gray-900 font-medium">Account Ref 2:</Label>
                          <Input id="accountRef2" placeholder="Enter second reference" className="border-gray-300 focus:border-yellow-500 focus:ring-yellow-500" />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="agencyDebt" className="text-gray-900 font-medium">Agency Debt Reference:</Label>
                          <Input id="agencyDebt" placeholder="Enter agency reference" className="border-gray-300 focus:border-yellow-500 focus:ring-yellow-500" />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="plaintNumber" className="text-gray-900 font-medium">Plaint Number:</Label>
                          <Input id="plaintNumber" placeholder="Enter plaint number" className="border-gray-300 focus:border-yellow-500 focus:ring-yellow-500" />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input id="portfolio" placeholder="Enter portfolio" className="border-gray-300 focus:border-yellow-500 focus:ring-yellow-500" />
                        </div>
                      </div>

                      <div className="flex items-center space-x-4">
                        <div className="flex items-center space-x-2">
                          <input type="checkbox" id="includeClosed" className="rounded border-gray-300 text-yellow-600 focus:ring-yellow-500" />
                        ...
                        <Button variant="outline" className="border-gray-300 text-gray-700 hover:bg-gray-100">List All Active Files</Button>
                      </div>
                    </div>
                        ...
                        <TableBody>
                          {fileSearchData.map((item, index) => (
                            <TableRow key={index} className="hover:bg-gray-50 cursor-pointer transition-colors"
                              onClick={() => setSelectedClient(item)}>
                              <TableCell className="font-medium text-yellow-700">{item.fileNum}</TableCell>
                              <TableCell className="text-gray-700">{item.accountRef}</TableCell>
                              ...
                              <TableCell className="text-yellow-700">{item.portfolio}</TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                      </Table>
